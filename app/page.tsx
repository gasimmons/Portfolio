          ...
          <section id="projects" className="py-24">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <ProjectCard
                  ...
                  description="SnapChef is a Swift-based iOS app that uses computer vision to identify ingredients from
                  fridge photos and generate recipe suggestions. Future features include pantry and freezer support,
                  smart grocery planning, and meal prep workflows. The project is a solo effort to deepen my skills in
                  Swift and applied machine learning."
                  image = "/assets/snapchef.png"
                  link={"https://github.com/gasimmons/SnapChef"}
                  tags={["Swift", "React"]}
              />
            </div>
          </section>
